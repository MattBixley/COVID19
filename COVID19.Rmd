...
p1 <- fiveper %>% 
  ...
  geom_line(data = fivenz, aes(x = days5, y = per_million, colour = country), size = 1.5)

p1 + theme_bw() + scale_colour_brewer(palette = "Paired") +
...
p2 <- dayssince %>% 
  ...
  geom_line(data = daysnz, aes(x = days, y = cum_cases, colour = country), size = 1.5) +
...
p2 + theme_bw() + scale_colour_brewer(palette = "Paired") + theme(legend.position="bottom")
...
p3 + theme_bw() + scale_colour_brewer(palette = "Oranges") +
