...
p1 + theme_bw() + scale_colour_brewer(palette = "Set1") +
  theme(legend.position="bottom")
#p1 + theme_bw() + scale_colour_brewer(palette = "Dark2")
...
p2 + theme_bw() + scale_colour_brewer(palette = "Set1") + theme(legend.position="bottom")
